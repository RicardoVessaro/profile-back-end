...
@SpringBootTest
public class UserControllerTestCopy {
    ...
    public void testInsert() {
        ...
        Link editLink = linkTo(methodOn(controller.getClass()).findById(entity.getId())).withRel("edit");
    ...
    public void testFindAll() {
        ...
        Link insertLink = linkTo(methodOn(controller.getClass()).insert(null)).withRel("create");
        assertThat(insertLink).isIn(response.getBody().getLinks());

        assertThat(response.getStatusCode()).isEqualTo(HttpStatus.OK);

        for(EntityModel<UserDTO> item: response.getBody().getContent()) {
            Link editLink = linkTo(methodOn(controller.getClass()).findById(item.getContent().getId()))
                .withRel("edit");
